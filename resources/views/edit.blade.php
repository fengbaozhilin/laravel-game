            ...
            <div class="box">
                <div class="padding-md ">
                    <div class="list-group text-center">
                        <a href="{{url('user/'.$user_id.'/edit')}}" class="list-group-item @if($filter == null) active @endif">
                            <i class="text-md fa fa-list-alt" aria-hidden="true"></i>
                            &nbsp;个人信息
                        </a>
                        <a href="{{url('user/'.$user_id.'/edit?filter=avatar')}}" class="list-group-item  @if($filter == 'avatar') active @endif ">
                            <i class="text-md fa fa-picture-o" aria-hidden="true"></i>
                            &nbsp;修改头像
                        </a>

                        <a href="{{url('user/'.$user_id.'/edit?filter=password')}}" class="list-group-item @if($filter == 'password') active @endif ">
